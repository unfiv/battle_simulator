...
Первая версия была в силу определённых причин (фокус на реализации, недостаточное планирование, ограничение по времени) была реализована с рядом фундаментальных ошибок:
...
- Текущий ход Юнита заканчивается, когда стек Намерений пуст, и очередь переходит к новому Юниту, который работает уже в "новой реальности". Это тот момент, который помогает нам обойти ограничение Очереди Событий.
